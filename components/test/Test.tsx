...
export default function Test({ className }: { className?: string }) {
  return (
    <div className="group mx-4 flex h-80 w-full min-w-[260px] flex-col gap-4 rounded-lg border-4 border-orange-700 bg-teal-500 hover:bg-teal-600 sm:w-[580px]">
      ...
      <div
        className={cn(
          "flex-1 px-3 text-sm leading-4 first-letter:text-3xl first-letter:text-gray-800 group-hover:font-bold group-hover:text-yellow-500",
          className,
        )}
      >
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad sapiente
        minus reprehenderit recusandae suscipit dignissimos ex molestias quidem
        libero perspiciatis, ipsum ratione veritatis totam iusto similique
        deleniti odit alias sint!
      </div>
      <div className="text-primary mx-auto text-sm">
