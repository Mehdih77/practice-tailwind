  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="group mx-4 flex h-80 w-full min-w-[260px] flex-col gap-4 rounded-lg border-4 border-orange-700 bg-teal-500 hover:bg-teal-600 sm:w-[580px]">
        ...
        <div className="flex-1 px-3 text-sm leading-4 text-gray-600 first-letter:text-3xl first-letter:text-gray-800 group-hover:font-bold group-hover:text-yellow-500">
